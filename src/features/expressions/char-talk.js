...
export function installCharTalk() {
    ...
    try {
        ...
        if (responsiveOwns('mouth')) return next(args);
            ...
            const hadProperty = !!mouth.Property;
            if (!mouth.Property) mouth.Property = {};
            const savedExpression = Object.getOwnPropertyDescriptor(mouth.Property, 'Expression');

            d.realExpression = mouth.Property.Expression ?? null;
            mouth.Property.Expression = d.currentExpression ?? null;
            try { return next(args); }
            finally {
                if (savedExpression) Object.defineProperty(mouth.Property, 'Expression', savedExpression);
                else delete mouth.Property.Expression;
                if (!hadProperty && Object.keys(mouth.Property).length === 0) delete mouth.Property;
            }
        });
